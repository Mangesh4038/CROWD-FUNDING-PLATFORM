    ...
    <>
      {loading ? (<ReactLoading type={"cylon"} color={"rgb(225, 41, 246)"} height={'50%'} width={'100%'} />) : (<>
        ...
        <div className="scrollmenu">
          <h5 onClick={() => { setCategory("Art") }}>Art</h5>
          <h5 onClick={() => { setCategory("Agriculture") }}>Agriculture</h5>
          <h5 onClick={() => { setCategory("Charity/NGO") }}>Charity/NGO</h5>
          ...
          <h5 onClick={() => { setCategory("Health Tech") }}>Health Tech</h5>
          <h5 onClick={() => { setCategory("Sports") }}>Sports</h5>
          <h5 onClick={() => { setCategory("Software & Services") }}>Software & Services</h5>
